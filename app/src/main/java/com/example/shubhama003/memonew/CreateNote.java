...
public class CreateNote extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       //ArrayAdapter adapter = ArrayAdapter.createFromResource(
             //this, R.array.note_type,android.R.layout.simple_list_item_1);

        ArrayAdapter<String> adapter2 =new ArrayAdapter<String>(this,android.R.layout.simple_list_item_1,getResources().getStringArray(R.array.note_type));
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch(item.getItemId()) {
            case R.id.action_save:
                ...
                long asd =  db.insert(mDbHelper.TABLE_NAME, null, cv);
                if(asd<0)
                {
                    Toast.makeText(CreateNote.this,"UnSuccesful",Toast.LENGTH_SHORT).show();

                }
                else
                {Toast.makeText(CreateNote.this,"Succesful",Toast.LENGTH_SHORT).show();}
