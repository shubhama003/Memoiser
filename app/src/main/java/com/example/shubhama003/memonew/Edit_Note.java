...
public class Edit_Note extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final String qwerty = getIntent().getExtras().getString("Titl");
        String args[] = {qwerty};
        Cursor cursor = db.rawQuery("select * from " + mDbHelper.TABLE_NAME + " where " + mDbHelper.TITLE + "=?", args);
        ...
        switch (item.getItemId()) {
            ...
            case R.id.action_save:
                ...
                if (checkBoxAlarm.isChecked()){
                   ...
                   // Toast.makeText(this,""+calender.getTimeInMillis(),Toast.LENGTH_LONG).show();
                   ...
                   // Toast.makeText(this,"date is "+dateString+" time is "+timeString,Toast.LENGTH_SHORT).show();
                ...
                String args[] = {qwerty};
                db.update(mDbHelper.TABLE_NAME, cv, mDbHelper.TITLE + "=?", args);
